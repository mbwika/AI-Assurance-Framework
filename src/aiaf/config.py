...
class Settings:
    ...
    api_key: Optional[str] = os.getenv("AIAF_API_KEY")
    api_version: str = os.getenv("AIAF_API_VERSION", "0.2.0")

    # ── Persistence ───────────────────────────────────────────────────────────
    pg_dsn: Optional[str] = os.getenv("AIAF_PG_DSN")
    ...
    # ── Signing keys ──────────────────────────────────────────────────────────
    attestation_key: Optional[str] = os.getenv("AIAF_ATTESTATION_KEY")
    attestation_key_id: str = os.getenv("AIAF_ATTESTATION_KEY_ID", "default")
    advisory_feed_key: Optional[str] = os.getenv("AIAF_ADVISORY_FEED_KEY")
    advisory_feed_key_id: str = os.getenv("AIAF_ADVISORY_FEED_KEY_ID", "default")
    report_signing_key: Optional[str] = os.getenv("AIAF_REPORT_SIGNING_KEY")
    ...
    otlp_endpoint: Optional[str] = os.getenv("AIAF_OTLP_ENDPOINT")

    # ── Notifications ─────────────────────────────────────────────────────────
    webhook_url: Optional[str] = os.getenv("AIAF_WEBHOOK_URL")
    webhook_secret: Optional[str] = os.getenv("AIAF_WEBHOOK_SECRET")
    slack_webhook_url: Optional[str] = os.getenv("AIAF_SLACK_WEBHOOK_URL")

    # ── Plugin system ─────────────────────────────────────────────────────────
    plugin_dir: Optional[str] = os.getenv("AIAF_PLUGIN_DIR")
